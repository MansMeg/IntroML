...
\begin{itemize}
    ...
    \item \textbf{GPT-3 (2020)}
    175B parameters; introduced few-shot prompting; breakthrough in general language capabilities.
\pause
    \item \textbf{2021–2022: Scaling + Instruction Tuning : ChatGPT}
    \begin{itemize}
        \item Models such as GPT-3.5, Gopher, Chinchilla, PaLM.
        \item Emergence of instruction-following
    \end{itemize}
    \pause

    \item \textbf{2023: GPT-4 Era}
    \begin{itemize}
        \item Stronger reasoning and tool-use abilities.
        \item Multimodal models (image+text)
        \item Open models: LLaMA, Falcon.
    \end{itemize}
    \pause

    \item \textbf{2024: Open-Weights Explosion}
    \begin{itemize}
        \item LLaMA-2/3, Mistral, Mixtral (MoE).
        \item Efficient inference and training.
        \item Models surpassing GPT-3 performance at a fraction of the size.
        \item Training data reached internet-size.
    \end{itemize}
    \pause

    \item \textbf{2025: Multimodal Models}
    \begin{itemize}
        \item Native multimodal architectures (audio–vision–text).
        \item Agents: reasoning + planning + tool execution.
        \item Increasing focus on safety, alignment, and retrieval-enhanced models.
        \item GPT-5 released
    \end{itemize}
