...
\begin{itemize}
\item A feedforward network with a \uured{single layer} of sufficient size can represent any function.
...
\item No indication of how large the network needs to be\pause
\end{itemize}
\end{itemize}
