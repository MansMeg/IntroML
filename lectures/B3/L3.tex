...
% Bernoulli units: Sigmoid  yˆ = Wh+b.
%yˆ = σ wh + b # Note only one value
...
% Other situations - use the negative log likelihood, e.g. poisson for counts, multivariate gaussian, ordinal data, survival models.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{fig/DL_6_3.png}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{fig/DL_6_6.png}
