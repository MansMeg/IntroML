...
\begin{frame}{This (two) week's lectures}
\begin{itemize}
...
Two main parts:
\begin{itemize}
\item Core Content (9 lecture blocks):
\begin{itemize}
\item Supervised learning (6 blocks)
...
\item All labs can be turned in a second time. Deadline last day of course.
