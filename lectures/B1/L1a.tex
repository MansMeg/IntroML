...
\begin{frame}{A Definition of AGI\\(Hendrycks et al., 2025)}

\begin{itemize}
\item \uured{AGI}: a model that matches or exceeds the \textbf{cognitive versatility and proficiency} of a well-educated adult.
\item \uured{Cattell–Horn–Carroll (CHC)} theory of human cognition.
\item Evaluates ten broad cognitive domains:
  \begin{itemize}
    \item Knowledge, Reading \& Writing, Math, Reasoning
    \item Working/Long-term Memory, Visual, Auditory, Speed
  \end{itemize}
\item Current models total score: \uured{GPT-4: 27\%}, \uured{GPT-5: 57\%}.
\end{itemize}
...
\centering
\includegraphics[width=0.8\textwidth]{figs/fig1_agi.png}
\vspace{1mm}
\scriptsize Figure 1: Cognitive abilities of GPT-4 vs GPT-5.

\end{frame}

\begin{frame}{What is Artificial Super Intelligence?}
...
\begin{itemize}
\item Over 70 years of AI research show that \emph{methods leveraging computation} outperform those using human knowledge.
\pause
\item Researchers often try to build human understanding into systems — this helps short term, but limits long-term progress.
\pause
\item \emph{Computation, search, and learning} scale with Moore’s law — they keep improving as compute increases.
\pause
\item Examples: Chess, Go, speech recognition, vision, language models — all advanced by scaling compute, not by encoding expert knowledge.
\pause
\item The bitter truth: \uured{General-purpose, scalable methods} win; human-designed structure eventually holds us back.
\end{itemize}
...
\item Oral exam (Block 1-5) \uured{New for this year} \pause
...
\begin{itemize}
\item To pass (G): All labs (at 75\%), mini-project and \uured{oral exam} needs to be passed\pause
...
\item Failing the course: You will need to redo all assignments, oral exam and mini-project.
\end{itemize}
...
\begin{itemize}
\item New this year. \uured{Purpose}: Additional exam of assignments (ChatGPT proof)\pause
\item Approx 60-70 questions based on the assignment 1-5 and the reading assignments.
\item \uured{If a question is not covered by the material - reach out!}
\item The 9th of November 13.15-16.00 H319
\item Random student will answer 1-2 random questions.
\item Pass/Fail at the spot.
\item Examiner Måns and Hannes.
\end{itemize}
\end{frame}
...
\item Literature
\begin{itemize}
\item \uured{Bishop \& Bishop (2024)} \emph{Deep Learning - Foundations and Concepts}.
...
\end{itemize}
\pause
\item If you have complaint - \uured{reach out to me in assignment evaluations}!
\pause
\item Notation and literature is difficult... hence a mess.
\end{itemize}
...
\begin{itemize}
\item Oral exam (I hope it works!)
