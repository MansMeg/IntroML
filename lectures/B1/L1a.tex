...
\begin{itemize}
\item One-two lectures/computer labs (approx. 2-4h)
\begin{itemize}
\item Lecture(s): present overall theory and content (overview)
\item Computer labs(s): Hands on help with the assignment if you get stuck. \uured{Start before the computer assignment!}
\end{itemize}
\item \uured{Ask questions!} \pause
\item Online video material and reading assignments (approx. 2-3h, 50-90 pages a week)
\item \emph{Note!} There might be some overlap between reading instructions.
\item An individual computer assignment (approx. 14-16h). Deadline Sundays 23.59.\pause
...
\item All assignments can be turned in a three times. 2nd deadline last day of course. 3rd deadline approx 2-4 weeks after the course. \uured{If failed, resubmit right away!}
\item We will mark and return each assignment within 10 working days.
\item \emph{Important!} Don't write your name anywhere and do the assignment evaluation!\pause
\item \emph{Important!} Don't \uured{show your assignment} to any other student. But feel free to discuss!
\item Computer labs:
\begin{enumerate}
  \item First lab each week will include a 15 min introduction
  \item Our focus: Help during computer labs - less focus on assignemnt feedback
\end{enumerate}
\end{enumerate}
