...
\begin{frame}{Classification Performance: the Confusion Matrix}
...
\begin{itemize}
\item In multiclass classification:
\end{itemize}
...
Of the predicted positives, how many are \uured{actually positive}?
...
or
\[
\text{Precision}_a = \frac{(T_a)}{T_a + F_{ab} + F_{ac})}
\]
