...
\begin{enumerate}
\item Research ammanuens positions (\href{https://swerik-project.github.io/}{https://swerik-project.github.io/})
\item Master Thesis project proposals
...
where
\[
\Omega(\hat{T} (x_i | \Theta_b)) = \lambda_1 |T| + \lambda_2 ||\gamma||^2
\]
where $|T|$ is the number of leafs.
\pause
