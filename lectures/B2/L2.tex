...
Short evaluation.
\begin{enumerate}
\item Assignment 1: Still needs to be reduced? What to remove?
\item More math?
\item Research ammanuens positions (deadline wednesday)
...
\item Questions are asked until a conclusion is reached\pause
\end{enumerate}
\end{itemize}
}
