...
\frame{\frametitle{3. Diagnose and improve: More data?}

\begin{itemize}
\item High training loss: Training data not fully used\pause
...
\begin{itemize}
\item Gather more data, or
\item Regularize to optimal capacity
\end{itemize}
\item \uured{How to know the improvemensts of additional data?}
\end{itemize}
}
...
\begin{itemize}
\item Avoid \uured{the algorithm rabbit hole}
