...
\begin{itemize}
\item Remember the project proposition deadline the \uured{today}
\item Still behind with grading...
\item New lecture by Holli Sargeant
\item Swap between 19th and 21th
\end{itemize}
...
\item {\color{uured} Generative} model\\ We can \emph{generate} samples from $p(x)$. \uured{Big right now!}
\end{itemize}
\pause
