...
\]
\item Conditional on $\tilde{\theta}$, choose action $A_t$ proportional to
\[
\arg \max_{a'} \E(R|\tilde{\theta},a')]\,,
\]
i.e. sample $A_t$ based on the probability of being the best action.
\end{enumerate}
