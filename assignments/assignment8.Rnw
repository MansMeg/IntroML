...
\begin{enumerate}
\item (2p) Implement the UCB algorithm as a function called \texttt{ucb\_algorithm(Q1, bandit, c)}. \emph{Hint!} If $N_t(a) = 0$, then $a$ should be considered as the maximizing action (i.e. should be chosen). This can be implemented in slightly different ways, so your output might not match the output below exactly even if the implementation is correct. The example output is based on choosing each arm randomly as long as any $N_t(a) = 0$.
<<eval = FALSE>>=
set.seed(4711)
Q1 <- rep(0, 5)
ucb_algorithm(Q1, stationary_bandit, c = 2)
## $Qt
## [1]  1.4792328 1.0928462 0.8417744 0.8360722 1.9867061
##
## $Nt
## [1]  64 26 16 17 877
##
...
##
## $Rt
## [1]  1.3525176 1.9163182 0.6335086 ...
...
## $Qt
## [1] 1.5993426 0.9645111 0.4399236 0.6868328 1.9736659
##
## $Nt
## [1]  98 21 10 14 857
##
