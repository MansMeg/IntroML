...
For this part of the assignment, Griffith and Steyvers (2004) is the primary reference. I would also recommend reading Blei (2012) before starting with the assignment.
