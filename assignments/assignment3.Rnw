...
\item (2p) Implement a simple feed-forward neural network in R using TensorFlow and Keras. See the introduction in \href{https://tensorflow.rstudio.com/tutorials/beginners/}{\textbf{[intro1]}} or in \href{https://cran.r-project.org/web/packages/keras/vignettes/index.html}{\textbf{[intro2]}}. Implement a neural network with one hidden layer with 16 units and the sigmoid as the activation function for the hidden layer. The output layer should be a softmax. Print your \texttt{keras} model description and include it in your report. \emph{Note} that depending on whether you use \texttt{keras} or \texttt{keras3}, how you pass the input layer of the network is slightly different. For \texttt{keras} the syntax used in \href{https://cran.r-project.org/web/packages/keras/vignettes/index.html}{\textbf{[intro2]}} works, while for \texttt{keras3}, the syntax used in \href{https://tensorflow.rstudio.com/tutorials/beginners/}{\textbf{[intro1]}} works.
\begin{enumerate}
