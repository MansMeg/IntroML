...
\item Visualize the clustering for the worst and the best clustering according to the within-point scatter (WPS). \emph{Note!} There might be some runs with the same WPS.
...
##
@
\item Implement the log-likelihood of the model as \texttt{ll\_uni\_two\_comp(x, theta)}. \emph{Hint!} See \citet[Eq. 8.39 in ][]{hastie2009elements}.
<<eval = FALSE>>=
...
<<eval = FALSE>>=
theta_em <- em_uni_two_comp(mixture_data, theta0, iter = 3)
## Log Lik:  -41.53247
## Log Lik:  -41.11211
## Log Lik:  -40.48348
@
