...
As a last part of the assignment, we will look into the probabilistic Principal Component analysis model. Here, Ch. 14 - 14.1 in \citet{Goodfellow-et-al-2016} is helpful.
