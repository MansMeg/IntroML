...
To get VG on this assignment, you can choose to make this task OR the task on transfer learning using VGG16 below.
...
To get VG on this assignment, you can choose to make this task OR the task on implementing a convolutional layer above.
