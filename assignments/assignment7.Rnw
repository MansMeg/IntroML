...
We are now going to implement a variational autoencoder in R using Tensorflow. You can find a lot of the code needed for this assignment in the file \href{https://github.com/MansMeg/IntroML/tree/master/additional_material/supplementary_r_files/variational_autoencoder_keras3.R}{\texttt{variational\_autoencoder\_keras3.R}}.
