...
Here general information is included that is needed for administrative/course purposes. **If this information is missing, the assignment will be failed**.

- **Name**: [Write your name here]
- **Student-ID**: [Write your student ID here]
- **Time use**: [How long time did the assignment took (in hours)]
